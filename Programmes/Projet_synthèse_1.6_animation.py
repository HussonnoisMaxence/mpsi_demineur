...
def chargement_images(Dossier_source_images):
    global gris, drapeau, drapeau_reussi, mine_fond_blanc, liste_images_chiffres, image_chiffre_0, image_chiffre_1, image_chiffre_2, image_chiffre_3, image_chiffre_4, image_chiffre_5, image_chiffre_6, image_chiffre_7, image_chiffre_8, image_chiffre_9, course_1, course_2, course_3, course_4, course_5, course_6, course_v_1, course_v_2, course_v_3, course_v_4, course_v_5, course_v_6, course_v_7, course_v_8, course_d_1
...
def equivalence_niveau(niveau):
    donnees_niveau=[[9,9,10],[16,16,40],[16,30,99],[5,5,1]]     #liste contenant les infos sur la taille et le nb de mines de chaque niveau
