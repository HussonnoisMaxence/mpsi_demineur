...
def afficher_case(ligne_de_la_case,colonne_de_la_case):
    ...
    case_chiffre='Case_chiffre_'+str(chiffre_case)+'.png'
    image_chiffre_case=mpimg.imread(case_chiffre)
    plt.imshow(image_chiffre_case,extent=(abs,abs+1,ord,ord+1))
